...
export function ArticleDetail({ article, locale }: { article: Article; locale: Locale }) {
  return (
    <article className="bg-[#e9e7e0]">
      ...
      <div className="site-container"><div className="relative aspect-[16/9] overflow-hidden md:aspect-[16/8]"><Image src={article.image} alt={article.title[locale]} fill priority quality={95} sizes="100vw" className="object-cover" /></div></div>
